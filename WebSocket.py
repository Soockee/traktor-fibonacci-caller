...
"""
Source: 
https://github.com/mutantzombie/WebSocketNotes/blob/master/scapy/WebSocket.py
by Mike Shema
...
class WebSocket(Packet):
  ...
  def post_dissection(self, pkt):
    if(pkt.mask_flag == 1 and pkt.frame_data is not None):
      ...
      pass
#bind Websocket on top of TCP layer on port "dport"
bind_layers(TCP, WebSocket,sport=8090, dport=8090)
